...
def example_with_telemetry():
    ...
    try:
        ...
        laps_with_telemetry = [
            {
                "lap_metadata": {"lap_number": 1, "lap_time": 95000, "valid": True},
                "telemetry_points": [
                    {
                        "timestamp": 0,
                        "speed": 0.0,
        ...
        session_id = exporter.export_complete_session(session_data, laps_with_telemetry)
...
def example_querying_data():
    ...
    try:
        ...
        if sessions:
            ...
            if best_lap:
                logger.info(
                    f"Best lap: {best_lap.lap_time}ms on lap {best_lap.lap_number}"
                )
