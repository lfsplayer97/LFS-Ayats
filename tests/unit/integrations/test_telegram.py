...
class TestTelegramIntegration:
    ...
    async def test_send_message_success(self, telegram_client):
        ...
        with patch('src.integrations.telegram_integration.aiohttp.ClientSession') as mock_session_class:
    ...
    async def test_send_message_exception(self, telegram_client):
        ...
        with patch('src.integrations.telegram_integration.aiohttp.ClientSession') as mock_session:
    ...
    async def test_send_photo_success(self, telegram_client):
        ...
        try:
            with patch('src.integrations.telegram_integration.aiohttp.ClientSession') as mock_session_class:
                ...
                result = await telegram_client.send_photo(test_photo, caption="Test photo")
