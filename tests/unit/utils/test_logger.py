...
class TestCreateSessionLogger:
    ...
    def test_session_logger_unique_names(self):
        ...
        # Names should be different (different timestamps or at least different instances)
        # They might have same name if created in same second, but should be valid loggers
    ...
    def test_session_logger_calls_setup(self, mock_setup):
        """Test session logger calls setup_logger with correct parameters."""
        mock_logger = MagicMock()
        mock_setup.return_value = mock_logger
        
        result = create_session_logger(base_name="test_session")
